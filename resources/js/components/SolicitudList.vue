<template>
    <div class="max-w-4xl mx-auto p-6">
      <h1 class="text-3xl text-white bg-green-800 p-4 rounded-lg mb-6 text-center">Listado de Solicitudes</h1>
      ...
      <div class="space-y-4">
        <div v-for="solicitud in solicitudes" :key="solicitud.id" class="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <div class="mt-4 flex space-x-4">
            <button @click="editSolicitud(solicitud.id)" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
              Modificar
            </button>
  ...
  export default {
    ...
    methods: {
      ...
      // Método para redirigir a la página de modificación
      editSolicitud(id) {
